    ...
    <div className="min-h-screen bg-brand-white font-sans">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <Button
          variant="ghost"
          onClick={() => navigate("/blog")}
          className="text-brand-dark-green hover:bg-brand-light-green/50 -ml-4"
        >
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-brand-dark-green mb-6 leading-tight">
            Organização Financeira em 2026: o Guia Definitivo para Começar o Ano com Clareza e Estratégia
          </h1>

          <div className="flex flex-wrap items-center gap-6 text-sm text-brand-dark-green/60 pb-8 border-b border-brand-dark-green/10">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="text-lg text-brand-dark-green/80 leading-relaxed mb-8">
          ...
          <p className="text-lg text-brand-dark-green/80 leading-relaxed mb-12">
          ...
          {/* Section 1 */}
          <h2 className="text-2xl sm:text-3xl font-bold text-brand-dark-green mt-12 mb-6">
            1. Comece pelo diagnóstico financeiro: o Raio-X que sustenta todas as decisões
          </h2>
          
          <p className="text-lg text-brand-dark-green/80 leading-relaxed mb-6">
          ...
          {/* CTAs */}
          <div className="bg-gradient-to-br from-brand-light-green/40 to-brand-cream/60 rounded-2xl p-8 mt-12">
            <p className="text-lg font-semibold text-brand-dark-green mb-6">
              Comece agora a organizar suas finanças:
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                onClick={() => navigate("/")}
                className="bg-brand-dark-green hover:bg-brand-dark-green/90 text-brand-white px-8 py-6 text-lg"
              >
                Para Empresas
              </Button>
              <Button
                onClick={() => navigate("/pessoal")}
                variant="outline"
                className="border-brand-dark-green text-brand-dark-green hover:bg-brand-dark-green hover:text-brand-white px-8 py-6 text-lg"
              >
                Para Pessoas
              </Button>
            </div>
        ...
        {/* Share */}
        <div className="flex items-center gap-4 mt-12 pt-8 border-t border-brand-dark-green/10">
          <span className="text-brand-dark-green/60 text-sm">Compartilhar:</span>
          <Button
            variant="ghost"
            size="sm"
            className="text-brand-dark-green hover:bg-brand-light-green/50"
            onClick={() => {
              if (navigator.share) {
                navigator.share({
      ...
      {/* Footer */}
      <footer className="bg-brand-dark-green py-12 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
