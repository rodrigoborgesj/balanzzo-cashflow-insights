...
const thumbnailComecePorAqui = "/lovable-uploads/thumbnail-comece-por-aqui.png";
...
export default function ComoUsar() {
  const tutorialVideos: Array<{
  ...
  }> = [
    {
      ...
      duration: "5:30",
      thumbnail: thumbnailComecePorAqui,
      videoUrl: "https://youtu.be/0TESbA9SVsw?si=T0aN-myT6jcLJnm3"
    },
    {
      id: 2,
