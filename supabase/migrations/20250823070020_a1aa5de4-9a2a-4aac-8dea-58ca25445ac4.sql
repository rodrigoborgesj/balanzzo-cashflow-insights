...
-- First, let's see what exists and update accordingly
...
BEGIN
    ...
    ELSE
        INSERT INTO subscription_plans (name, price_cents, billing_cycle, features, active, pagarme_plan_id)
        VALUES ('Balanzzo Semestral', 14990, 'semiannual', '["6 meses com desconto", "Todas as funcionalidades Premium", "Suporte VIP"]'::jsonb, true, 'plan_vmQOLPKZFDt2qx6k');
    END IF;
END $$;